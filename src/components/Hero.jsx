...
const Hero = () => {
  return (
    <section className='flex flex-col md:flex-row justify-between px-8 md:px-[12rem] py-10 text-[2rem] md:text-[2.5rem] font-ibmMono font-[500] items-center mb-24' style={{ color: 'var(--hero-color)' }}>
