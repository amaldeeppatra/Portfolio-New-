...
const Hero = () => {
  return (
    <section className='flex flex-col md:flex-row justify-between px-8 md:px-[12rem] py-10 text-[2rem] md:text-[2.5rem] font-ibmMono font-[500] items-center mb-24'>
      <div className='left flex flex-col items-center md:items-start text-center md:text-left'>
        ...
        <p className='font-bold mt-2' style={{ color: 'var(--hero-color)' }}>Amaldeep Patra</p>
        <p className='text-base md:text-lg w-full md:w-[21rem] mt-4' style={{ color: 'var(--hero-color)' }}>"Hi, I'm Amaldeep Patra, a CSE grad skillful in Full Stack Web Development and ML."</p>
      </div>
